...
import {
  ...
  FaFlask, FaUserCheck, FaBookOpen, FaTabletAlt, FaTags, FaTools, FaUserPlus, FaBoxes, FaWallet, FaClipboardCheck, FaFileContract, FaUserShield, FaUsersCog, FaCalendarAlt, FaFolderOpen, FaLightbulb
} from 'react-icons/fa';
...
const roleMenus = {
  ...
  { label: 'Budget & Finance', to: '/zone/finance', icon: <FaWallet /> },
  ...
  senate: [
    { label: 'Senate Dashboard', to: '/dashboard', icon: <FaTachometerAlt /> },
    { label: 'Motions', to: '/senate/motions', icon: <FaFileAlt /> },
  ],
  school: [
  { label: 'Dashboard', to: '/dashboard', icon: <FaTachometerAlt /> },
